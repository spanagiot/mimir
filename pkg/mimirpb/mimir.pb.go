...
type TimeSeriesNoExemplars struct {
	Labels []LabelAdapter `protobuf:"bytes,1,rep,name=labels,proto3,customtype=LabelAdapter" json:"labels"`
	// Sorted by time, oldest sample first.
	Samples    []Sample    `protobuf:"bytes,2,rep,name=samples,proto3" json:"samples"`
	Histograms []Histogram `protobuf:"bytes,4,rep,name=histograms,proto3" json:"histograms"`
...
func (m *TimeSeriesNoExemplars) Reset()      { *m = TimeSeriesNoExemplars{} }
func (*TimeSeriesNoExemplars) ProtoMessage() {}
func (*TimeSeriesNoExemplars) Descriptor() ([]byte, []int) {
	return fileDescriptor_86d4d7485f544059, []int{4}
}
func (m *TimeSeriesNoExemplars) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TimeSeriesNoExemplars) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TimeSeriesNoExemplars.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TimeSeriesNoExemplars) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TimeSeriesNoExemplars.Merge(m, src)
}
func (m *TimeSeriesNoExemplars) XXX_Size() int {
	return m.Size()
}
func (m *TimeSeriesNoExemplars) XXX_DiscardUnknown() {
	xxx_messageInfo_TimeSeriesNoExemplars.DiscardUnknown(m)
}

var xxx_messageInfo_TimeSeriesNoExemplars proto.InternalMessageInfo

func (m *TimeSeriesNoExemplars) GetSamples() []Sample {
	if m != nil {
		return m.Samples
	}
	return nil
...
func (m *TimeSeriesNoExemplars) GetHistograms() []Histogram {
	if m != nil {
		return m.Histograms
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TimeSeriesNoExemplars)(nil), "cortexpb.TimeSeriesNoExemplars")
...
var fileDescriptor_86d4d7485f544059 = []byte{
	...
	,
}
...
func (this *TimeSeriesNoExemplars) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TimeSeriesNoExemplars)
	if !ok {
		that2, ok := that.(TimeSeriesNoExemplars)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TimeSeriesNoExemplars) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&mimirpb.TimeSeriesNoExemplars{")
	s = append(s, "Labels: "+fmt.Sprintf("%#v", this.Labels)+",\n")
	if this.Samples != nil {
		vs := make([]*Sample, len(this.Samples))
		for i := range vs {
...
func (m *TimeSeriesNoExemplars) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TimeSeriesNoExemplars) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TimeSeriesNoExemplars) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TimeSeriesNoExemplars) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *TimeSeriesNoExemplars) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForSamples := "[]Sample{"
	...
	repeatedStringForHistograms += "}"
	s := strings.Join([]string{`&TimeSeriesNoExemplars{`,
		`Labels:` + fmt.Sprintf("%v", this.Labels) + `,`,
		`Samples:` + repeatedStringForSamples + `,`,
		`Histograms:` + repeatedStringForHistograms + `,`,
		`}`,
...
func (m *TimeSeriesNoExemplars) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TimeSeriesNoExemplars: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TimeSeriesNoExemplars: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
